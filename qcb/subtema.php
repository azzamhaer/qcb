...
$query = "SELECT * FROM `subtema` WHERE `id`='" . $id . "'";
...
<h1><?php echo $row['subtema']; ?></h1>
<br><br>
<h2><a class="alink" href="keyword.php?id=<?php echo $row['sublink1']; ?>"><?php echo $row['subtopik1']; ?></a></h2>
<br>
<h2><a class="alink" href="keyword.php?id=<?php echo $row['sublink2']; ?>"><?php echo $row['subtopik2']; ?></a></h2>
<br>
<h2><a class="alink" href="keyword.php?id=<?php echo $row['sublink3']; ?>"><?php echo $row['subtopik3']; ?></a></h2>
<br><br><br>
	<div class="credits">
		<div class="responsive-container">
